...
- plan 2 is compound interest
  ...
  #+RESULTS:
  : 30772.47909800001
***  [[pdf:./notes/lecture/markup/2021a L3 Economic Equivalence Single Cashflow (with notes).pdf::14][Equivalence Example 3.3]]
- 8% interest (yearly)
...
<<imports>>
#+end_src
*** Example 3.11 Present Values of an Uneven Series by Decomposition into Single Payments
How much do you need to deposit today (P) to withdraw $25 000 at n=1, $3000 at n=2,
TODO: finish this example

** Types of cash flows
 TODO: insert five types of cash flows slide 5-20
...
- Linear Gradient Series :: a series of clash flows increasing or decreasing by a fixed amount at regular intervals
